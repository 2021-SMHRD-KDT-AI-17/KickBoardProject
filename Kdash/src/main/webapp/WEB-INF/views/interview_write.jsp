...
<% 
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="text-center"><a href="#"><i class="ti ti-ad-2"></i></a>인터뷰 글 작성</h1><br>
              ...
              <div class="card-body p-4">
                <form action="interview_insert">
                  ...
                  <div class="text-end">
                    ...
                    <button type="button" class="btn btn-secondary">글작성 취소</button>
                  </div>
                </form>
              </div>
            </div>
  ...
  <script src="resources/assets/js/findkeyword.js"></script>
